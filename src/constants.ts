...
export const dialogues = {
    ...
    stick: 'Thanks for letting me out from under there! My weapon is the cudgel over there, it might look like a stick to you right now!',
...
export const videos = {
    ...
    stick: 'https://youtu.be/wRKRwz0oHRE?si=zqYHFIOpqzO_989u&t=1073',
